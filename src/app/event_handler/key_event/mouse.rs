...
pub fn handle_mouse_event(mouse: ratatui::crossterm::event::MouseEvent, app: &mut App) {
    ...
    match mouse.kind {
        MouseEventKind::Down(MouseButton::Left) => {
            ...
            // Find the toggle whose position is closest to the click, within
            // a tolerance of 3 lines (to account for word-wrap reflow).
            let tol: u16 = 3;
            let mut found: Option<String> = None;
            for &(toggle_line, ref section_id) in &app.collapsed_toggles {
